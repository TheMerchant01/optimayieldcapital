    ...
    <div className="">
      {details !== 0 && (
        <div className="grid md:grid-cols-2 grid-cols-1 w-full gap-3">
          <div
            className={`flex relative overflow-hidden justify-between items-center p-4 rounded-md w-full ${isDarkMode
                ? "bg-[#111] border border-white/5 text-white"
                : "bg-black/5 border"
              }`}
          >
            <div
              className={`absolute z-20 -bottom-2 ${pathname.includes("investment") ? "right-5" : "right-40"
                } `}
            >
            ...
            <div className="flex items-center gap-x-3">
              {" "}
              <div
                className={`image_cont rounded-full h-full p-3 ${isDarkMode ? "bg-[#222]" : "bg-black/10"
                  }`}
              >
                {details.investmentPackage === "bronze plan" ? (
                  <Image
            ...
            <div className="action">
              <Link href="/dashboard/main-investment" passHref>
                <button
                  className={`py-2 z-50 text-[#7dbf09] px-4 bg-[#00a05510] rounded-md text-sm font-bold ${pathname.includes("main-investment") ? "hidden" : ""
                    }`}
                >
