...
export default function Copy() {
  ...
  const handleCopyTrader = async () => {
    ...
    if (isNaN(enteredAmount) || enteredAmount < minPrice || enteredAmount > maxPrice) {
      ...
      {details !== 0 && (
        <div className="pt-4 px-4 ">
          ...
          <div className="input-region">
            <div
              className={`rounded-md mt-5 flex items-center px-3 capitalize w-full ${isDarkMode
          ...
          <div className="traders-region mt-6">
            <div className="grid grid-cols-1 w-full md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {filteredTraders.map((traders) => (
                <>
                  <div
                    className={`border w-full p-3 relative rounded-md ${isDarkMode
                  ...
                  >
                    <div className="flag absolute top-2 right-2">
                      <div
                        className={`rounded-sm p-3 ${isDarkMode ? "bg-[#222]" : "bg-black/5"
                          }`}
                      >
                    ...
                    <div className="trader-name font-bold text-center capitalize text-xl mt-4 justify-center items-center flex">
                      ...
                      {traders.verified && (
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          fill="currentColor"
                          className="w-5 h-5 ml-1 text-[#7dbf09]"
                        >
                          <path
                            fillRule="evenodd"
                    ...
                    <div
                      className={`location flex items-center gap-x-1 mt-2 justify-center ${isDarkMode ? "text-white/30" : "text-black/30"
                        }`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                      className={`key-items mt-2 flex gap-x-3 justify-center items-center ${isDarkMode ? "text-white/80" : "text-black/70"
                        }`}
                    >
                      <div
                        className={`totalTrades flex items-center p-2 rounded-sm ${isDarkMode ? "bg-[#222]" : "bg-black/5"
                          }`}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    ...
                    <div className="other-deets grid grid-cols-2 gap-x-2 mt-2">
                      <div
                        className={`winrate flex items-center justify-between p-3 rounded-sm mt-2 ${isDarkMode
                      ...
                      <div
                        className={`winrate flex items-center justify-between p-3 rounded-sm mt-3 ${isDarkMode
                            ? "bg-[#2222225c] text-white/70"
                            : "bg-black/5 text-black/70"
                          }`}
                      >
                    ...
                    >
                      <button
                        className={`${isDarkMode ? "text-white" : "text-black/90"
                          } rounded-md px-4 py-3 text-sm font-bold ${details.tradersCopying.includes(traders.id)
                            ? "bg-orange-600 text-white"
                            : copying
                              ? isDarkMode
                                ? "bg-[#2826264f] cursor-not-allowed"
                                : "bg-black/5 cursor-not-allowed"
                              : "bg-[#7dbf09] text-white"
                          }  `}
                      >
      ...
      {selectedTrader && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-md shadow-lg w-96">
            <h2 className="text-xl font-bold mb-4">Copy {selectedTrader.nickname}</h2>
            <p>Min Amount: ${selectedTrader.minPrice} | Max Amount: ${selectedTrader.maxPrice}</p>
            <input
              type="number"
