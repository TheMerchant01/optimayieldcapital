      ...
      try {
        const uploadedImageUrls = await Promise.all(
          acceptedFiles.map(async (file) => {
            ...
            formData.append("upload_preset", "royalassets");
            try {
              const response = await axios.post(
                `https://api.cloudinary.com/v1_1/dmkzaiti0/upload`, // Replace with your Cloudinary URL
                formData
              );
              ...
              >
                ...
                >
                  <p>
                    ...
                    Make sure you deposit the exact amount specified to avoid deposit verification failure.{" "}
                  </p>
                </div>
