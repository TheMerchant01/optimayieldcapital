        ...
        <section className="text_section md:px-8 px-2 pt-7">
          <div className="textcontaier">
            <div
              ...
              data-aos-delay="100"
            >
              Follow <span className="text-[#7dbf09]">Top-performing</span>{" "}
              traders
            </div>
            <div
            ...
            >
              ...
              >
                <div className="icon">
                  <svg
                    ...
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="w-6 h-6 mr-2 text-[#7dbf09]"
                  >
                    <path
                      fillRule="evenodd"
                ...
                <div className="message">
                  Follow & copy{" "}
                  <span className="font-bold text-[#7dbf09]">
                    top-performing
                  </span>{" "}
                  traders
                </div>
              ...
              >
                ...
                <div className="message">
                  ...
                  <span className="text-[#7dbf09] font-bold">trading plan</span>
                </div>
              </div>
            </div>
          </div>
