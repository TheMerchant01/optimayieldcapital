          ...
          <div className="message">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-4 h-4 mr-1 text-[#7dbf09]"
              >
            ...
            >
              <p className="text-xl md:text-2xl lg:text-3xl font-bold my-3">
                Top <span className="text-[#7dbf09]">Companies</span> and{" "}
                <span className="text-[#7dbf09]">Trade</span> Partners 🤝
              </p>
            </div>
            <div
            ...
            >
              ...
              recognized Optima Yield Capital as a trusted and reliable entity
              but have also extended their support in forming strong
              partnerships. This collaborative effort reflects the high level of
              trust and credibility that Optima Yield Capital has garnered within
